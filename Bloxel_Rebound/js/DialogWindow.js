(function (window) {
	...
	function DialogWindow() {
        ...
        this.tick = function (delta) {
            ...
            if (this.dialog != null){
                if (this.dialog.state == "pause"){ //pause screen
                    ...
                    if (window.Game.home.selectedLevel > 10 &&
                        window.storageManager.hasLicense() == false &&
                        window.Game.prevView == 1) {
                        if (this.button_1.isClicked()) { buyProduct('boxel_rebound_pro'); this.checkGameOverOptions(); }
                        else if (this.button_2.isClicked()) { this.checkGameOverOptions(); }
                    }
                    else { //license owners options
                    ...
                    if (this.button_1.isClicked()){ buyProduct('boxel_rebound_pro'); }
                    else if (this.button_2.isClicked()){ this.removeDialogWindow(); }
                }
        ...
        this.createDialogWindow = function(state){
            ...
            if (state == "pause"){ //menu dialog
                ...
                if (level > 10 && 
                    ...
                    this.text_2.y = this.box * 8;
                    this.text_2.set({ font: (this.fontSize * 0.8)+"px prstart" });
                    this.button_1.setText('Upgrade');
                    this.button_2.setText('Continue');
                    this.text_1.text = "Finished!";
                    this.text_2.text = "Upgrade to PRO\n\nto unlock skins";
                    this.addSkinOptions(); // click will not work because 'pause' is true
                    this.dialog.addChild(this.bg, this.text_1, this.text_2, this.skins, this.button_1, this.button_2);
                }
                ...
                this.text_1.text = "";
                this.text_2.text = "Please try again in 24 hours or upgrade to Boxel Rebound Pro for unlimited uploads.";
                ...
                this.text_1.text = "";
                this.text_2.text = "Upgrade to Boxel Rebound Pro for unlimited custom levels.";
                this.text_1.y = this.box * 2;
                this.text_2.y = this.box * 4;
                this.button_1.setText('Upgrade');
                this.button_2.setText('Continue');
        ...
        this.addSkinOptions = function(){
            ...
            var hasLicense = window.storageManager.hasLicense();
        ...
        this.saveDownload = function(){
            if (window.Game.levelEditor.levelButtons.children.length < 3 || window.storageManager.hasLicense()){
