	...
	function DialogWindow() {
        ...
        this.tick = function (delta) {
            ...
            if (this.dialog != null){
                ...
                else if (this.dialog.state == "complete"){ //level complete dialog actions
        ...
        this.createDialogWindow = function(state){
            ...
            if (state == "pause"){ //menu dialog
                ...
                //Compare score with saved score
                ...
                if (window.Game.prevView == 1){ //if home was the origin
                ...
                this.text_2.text = "Great work! You beat all 30 levels! Now go make your own levels!";
                this.text_1.y = this.box * 6;
                this.text_2.y = this.box * 8;
                this.button_2.setText('Continue');
                this.dialog.addChild(this.bg, this.text_1, this.text_2, this.button_2); //exclude button_1
                ga('send', 'event', 'game', 'beat');
            }
                ...
                this.text_2.text = "You have received a new level. This code will now expire.";
                this.text_1.y = this.box * 4;
                this.text_2.y = this.box * 6;
        ...
        this.setDefaultDialogElements = function(){
            ...
            this.bg.graphics.beginFill('rgba(0,0,0,0.5)').drawRect(0,0,this.width,this.height);
        ...
        this.submitCode = function(){
            var input = this.input.getChildByName("input");
            //window.Game.gamePaused = false;
            window.storageManager.loadLevelFromFirebase(input.text.substring(1));
        };
